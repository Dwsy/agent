 ...
 */const D=globalThis,ae=D.ShadowRoot&&(D.ShadyCSS===void 0||D.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,oe=Symbol(),le=new WeakMap;let ke=class{constructor(e,r,a){if(this._$cssResult$=!0,a!==oe)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=r}get styleSheet(){let e=this.o;const r=this.t;if(ae&&e===void 0){const a=r!==void 0&&r.length===1;a&&(e=le.get(r)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),a&&le.set(r,e))}return e}toString(){return this.cssText}};const Re=t=>new ke(typeof t=="string"?t:t+"",void 0,oe),v=(t,...e)=>{const r=t.length===1?t[0]:e.reduce((a,s,o)=>a+(i=>{if(i._$cssResult$===!0)return i.cssText;if(typeof i=="number")return i;throw Error("Value passed to 'css' function must be a 'css' function result: "+i+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+t[o+1],t[0]);return new ke(r,t,oe)},Ne=(t,e)=>{if(ae)t.adoptedStyleSheets=e.map(r=>r instanceof CSSStyleSheet?r:r.styleSheet);else for(const r of e){const a=document.createElement("style"),s=D.litNonce;s!==void 0&&a.setAttribute("nonce",s),a.textContent=r.cssText,t.appendChild(a)}},ce=ae?t=>t:t=>t instanceof CSSStyleSheet?(e=>{let r="";for(const a of e.cssRules)r+=a.cssText;return Re(r)})(t):t;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:Le,defineProperty:Ue,getOwnPropertyDescriptor:De,getOwnPropertyNames:Ge,getOwnPropertySymbols:He,getPrototypeOf:je}=Object,$=globalThis,de=$.trustedTypes,Be=de?de.emptyScript:"",K=$.reactiveElementPolyfillSupport,z=(t,e)=>t,G={toAttribute(t,e){switch(e){case Boolean:t=t?Be:null;break;case Object:case Array:t=t==null?t:JSON.stringify(t)}return t},fromAttribute(t,e){let r=t;switch(e){case Boolean:r=t!==null;break;case Number:r=t===null?null:Number(t);break;case Object:case Array:try{r=JSON.parse(t)}catch{r=null}}return r}},ie=(t,e)=>!Le(t,e),pe={attribute:!0,type:String,converter:G,reflect:!1,useDefault:!1,hasChanged:ie};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),$.litPropertyMetadata??($.litPropertyMetadata=new WeakMap);let C=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??(this.l=[])).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,r=pe){if(r.state&&(r.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((r=Object.create(r)).wrapped=!0),this.elementProperties.set(e,r),!r.noAccessor){const a=Symbol(),s=this.getPropertyDescriptor(e,a,r);s!==void 0&&Ue(this.prototype,e,s)}}static getPropertyDescriptor(e,r,a){const{get:s,set:o}=De(this.prototype,e)??{get(){return this[r]},set(i){this[r]=i}};return{get:s,set(i){const l=s==null?void 0:s.call(this);o==null||o.call(this,i),this.requestUpdate(e,l,a)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??pe}static _$Ei(){if(this.hasOwnProperty(z("elementProperties")))return;const e=je(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(z("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(z("properties"))){const r=this.properties,a=[...Ge(r),...He(r)];for(const s of a)this.createProperty(s,r[s])}const e=this[Symbol.metadata];if(e!==null){const r=litPropertyMetadata.get(e);if(r!==void 0)for(const[a,s]of r)this.elementProperties.set(a,s)}this._$Eh=new Map;for(const[r,a]of this.elementProperties){const s=this._$Eu(r,a);s!==void 0&&this._$Eh.set(s,r)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const r=[];if(Array.isArray(e)){const a=new Set(e.flat(1/0).reverse());for(const s of a)r.unshift(ce(s))}else e!==void 0&&r.push(ce(e));return r}static _$Eu(e,r){const a=r.attribute;return a===!1?void 0:typeof a=="string"?a:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var e;this._$ES=new Promise(r=>this.enableUpdating=r),this._$AL=new Map,this._$E_(),this.requestUpdate(),(e=this.constructor.l)==null||e.forEach(r=>r(this))}addController(e){var r;(this._$EO??(this._$EO=new Set)).add(e),this.renderRoot!==void 0&&this.isConnected&&((r=e.hostConnected)==null||r.call(e))}removeController(e){var r;(r=this._$EO)==null||r.delete(e)}_$E_(){const e=new Map,r=this.constructor.elementProperties;for(const a of r.keys())this.hasOwnProperty(a)&&(e.set(a,this[a]),delete this[a]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Ne(e,this.constructor.elementStyles),e}connectedCallback(){var e;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$EO)==null||e.forEach(r=>{var a;return(a=r.hostConnected)==null?void 0:a.call(r)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$EO)==null||e.forEach(r=>{var a;return(a=r.hostDisconnected)==null?void 0:a.call(r)})}attributeChangedCallback(e,r,a){this._$AK(e,a)}_$ET(e,r){var o;const a=this.constructor.elementProperties.get(e),s=this.constructor._$Eu(e,a);if(s!==void 0&&a.reflect===!0){const i=(((o=a.converter)==null?void 0:o.toAttribute)!==void 0?a.converter:G).toAttribute(r,a.type);this._$Em=e,i==null?this.removeAttribute(s):this.setAttribute(s,i),this._$Em=null}}_$AK(e,r){var o,i;const a=this.constructor,s=a._$Eh.get(e);if(s!==void 0&&this._$Em!==s){const l=a.getPropertyOptions(s),n=typeof l.converter=="function"?{fromAttribute:l.converter}:((o=l.converter)==null?void 0:o.fromAttribute)!==void 0?l.converter:G;this._$Em=s;const p=n.fromAttribute(r,l.type);this[s]=p??((i=this._$Ej)==null?void 0:i.get(s))??p,this._$Em=null}}requestUpdate(e,r,a,s=!1,o){var i;if(e!==void 0){const l=this.constructor;if(s===!1&&(o=this[e]),a??(a=l.getPropertyOptions(e)),!((a.hasChanged??ie)(o,r)||a.useDefault&&a.reflect&&o===((i=this._$Ej)==null?void 0:i.get(e))&&!this.hasAttribute(l._$Eu(e,a))))return;this.C(e,r,a)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,r,{useDefault:a,reflect:s,wrapped:o},i){a&&!(this._$Ej??(this._$Ej=new Map)).has(e)&&(this._$Ej.set(e,i??r??this[e]),o!==!0||i!==void 0)||(this._$AL.has(e)||(this.hasUpdated||a||(r=void 0),this._$AL.set(e,r)),s===!0&&this._$Em!==e&&(this._$Eq??(this._$Eq=new Set)).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(r){Promise.reject(r)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var a;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[o,i]of this._$Ep)this[o]=i;this._$Ep=void 0}const s=this.constructor.elementProperties;if(s.size>0)for(const[o,i]of s){const{wrapped:l}=i,n=this[o];l!==!0||this._$AL.has(o)||n===void 0||this.C(o,void 0,i,n)}}let e=!1;const r=this._$AL;try{e=this.shouldUpdate(r),e?(this.willUpdate(r),(a=this._$EO)==null||a.forEach(s=>{var o;return(o=s.hostUpdate)==null?void 0:o.call(s)}),this.update(r)):this._$EM()}catch(s){throw e=!1,this._$EM(),s}e&&this._$AE(r)}willUpdate(e){}_$AE(e){var r;(r=this._$EO)==null||r.forEach(a=>{var s;return(s=a.hostUpdated)==null?void 0:s.call(a)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&(this._$Eq=this._$Eq.forEach(r=>this._$ET(r,this[r]))),this._$EM()}updated(e){}firstUpdated(e){}};C.elementStyles=[],C.shadowRootOptions={mode:"open"},C[z("elementProperties")]=new Map,C[z("finalized")]=new Map,K==null||K({ReactiveElement:C}),($.reactiveElementVersions??($.reactiveElementVersions=[])).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
\f\r"'\`<>=]|("|')|))|$)`,"g"),fe=/'/g,be=/"/g,Ae=/^(?:script|style|textarea|title)$/i,Ye=t=>(e,...r)=>({_$litType$:t,strings:e,values:r}),h=Ye(1),S=Symbol.for("lit-noChange"),m=Symbol.for("lit-nothing"),ve=new WeakMap,_=A.createTreeWalker(A,129);function Ce(t,e){if(!ne(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return me!==void 0?me.createHTML(e):e}const qe=(t,e)=>{const r=t.length-1,a=[];let s,o=e===2?"<svg>":e===3?"<math>":"",i=T;for(let l=0;l<r;l++){const n=t[l];let p,u,d=-1,b=0;for(;b<n.length&&(i.lastIndex=b,u=i.exec(n),u!==null);)b=i.lastIndex,i===T?u[1]==="!--"?i=ue:u[1]!==void 0?i=ge:u[2]!==void 0?(Ae.test(u[2])&&(s=RegExp("</"+u[2],"g")),i=k):u[3]!==void 0&&(i=k):i===k?u[0]===">"?(i=s??T,d=-1):u[1]===void 0?d=-2:(d=i.lastIndex-u[2].length,p=u[1],i=u[3]===void 0?k:u[3]==='"'?be:fe):i===be||i===fe?i=k:i===ue||i===ge?i=T:(i=k,s=void 0);const x=i===k&&t[l+1].startsWith("/>")?" ":"";o+=i===T?n+We:d>=0?(a.push(p),n.slice(0,d)+_e+n.slice(d)+w+x):n+w+(d===-2?l:x)}return[Ce(t,o+(t[r]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),a]};class N{constructor({strings:e,_$litType$:r},a){let s;this.parts=[];let o=0,i=0;const l=e.length-1,n=this.parts,[p,u]=qe(e,r);if(this.el=N.createElement(p,a),_.currentNode=this.el.content,r===2||r===3){const d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(s=_.nextNode())!==null&&n.length<l;){if(s.nodeType===1){if(s.hasAttributes())for(const d of s.getAttributeNames())if(d.endsWith(_e)){const b=u[i++],x=s.getAttribute(d).split(w),U=/([.?@])?(.*)/.exec(b);n.push({type:1,index:o,name:U[2],strings:x,ctor:U[1]==="."?Fe:U[1]==="?"?Ke:U[1]==="@"?Xe:J}),s.removeAttribute(d)}else d.startsWith(w)&&(n.push({type:6,index:o}),s.removeAttribute(d));if(Ae.test(s.tagName)){const d=s.textContent.split(w),b=d.length-1;if(b>0){s.textContent=H?H.emptyScript:"";for(let x=0;x<b;x++)s.append(d[x],I()),_.nextNode(),n.push({type:2,index:++o});s.append(d[b],I())}}}else if(s.nodeType===8)if(s.data===Pe)n.push({type:2,index:o});else{let d=-1;for(;(d=s.data.indexOf(w,d+1))!==-1;)n.push({type:7,index:o}),d+=w.length-1}o++}}static createElement(e,r){const a=A.createElement("template");return a.innerHTML=e,a}}function E(t,e,r=t,a){var i,l;if(e===S)return e;let s=a!==void 0?(i=r._$Co)==null?void 0:i[a]:r._$Cl;const o=R(e)?void 0:e._$litDirective$;return(s==null?void 0:s.constructor)!==o&&((l=s==null?void 0:s._$AO)==null||l.call(s,!1),o===void 0?s=void 0:(s=new o(t),s._$AT(t,r,a)),a!==void 0?(r._$Co??(r._$Co=[]))[a]=s:r._$Cl=s),s!==void 0&&(e=E(t,s._$AS(t,e.values),s,a)),e}class Je{constructor(e,r){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=r}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:r},parts:a}=this._$AD,s=((e==null?void 0:e.creationScope)??A).importNode(r,!0);_.currentNode=s;let o=_.nextNode(),i=0,l=0,n=a[0];for(;n!==void 0;){if(i===n.index){let p;n.type===2?p=new L(o,o.nextSibling,this,e):n.type===1?p=new n.ctor(o,n.name,n.strings,this,e):n.type===6&&(p=new Ze(o,this,e)),this._$AV.push(p),n=a[++l]}i!==(n==null?void 0:n.index)&&(o=_.nextNode(),i++)}return _.currentNode=A,s}p(e){let r=0;for(const a of this._$AV)a!==void 0&&(a.strings!==void 0?(a._$AI(e,a,r),r+=a.strings.length-2):a._$AI(e[r])),r++}}class L{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,r,a,s){this.type=2,this._$AH=m,this._$AN=void 0,this._$AA=e,this._$AB=r,this._$AM=a,this.options=s,this._$Cv=(s==null?void 0:s.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const r=this._$AM;return r!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=r.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,r=this){e=E(this,e,r),R(e)?e===m||e==null||e===""?(this._$AH!==m&&this._$AR(),this._$AH=m):e!==this._$AH&&e!==S&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Ve(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==m&&R(this._$AH)?this._$AA.nextSibling.data=e:this.T(A.createTextNode(e)),this._$AH=e}$(e){var o;const{values:r,_$litType$:a}=e,s=typeof a=="number"?this._$AC(e):(a.el===void 0&&(a.el=N.createElement(Ce(a.h,a.h[0]),this.options)),a);if(((o=this._$AH)==null?void 0:o._$AD)===s)this._$AH.p(r);else{const i=new Je(s,this),l=i.u(this.options);i.p(r),this.T(l),this._$AH=i}}_$AC(e){let r=ve.get(e.strings);return r===void 0&&ve.set(e.strings,r=new N(e)),r}k(e){ne(this._$AH)||(this._$AH=[],this._$AR());const r=this._$AH;let a,s=0;for(const o of e)s===r.length?r.push(a=new L(this.O(I()),this.O(I()),this,this.options)):a=r[s],a._$AI(o),s++;s<r.length&&(this._$AR(a&&a._$AB.nextSibling,s),r.length=s)}_$AR(e=this._$AA.nextSibling,r){var a;for((a=this._$AP)==null?void 0:a.call(this,!1,!0,r);e!==this._$AB;){const s=he(e).nextSibling;he(e).remove(),e=s}}setConnected(e){var r;this._$AM===void 0&&(this._$Cv=e,(r=this._$AP)==null||r.call(this,e))}}class J{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,r,a,s,o){this.type=1,this._$AH=m,this._$AN=void 0,this.element=e,this.name=r,this._$AM=s,this.options=o,a.length>2||a[0]!==""||a[1]!==""?(this._$AH=Array(a.length-1).fill(new String),this.strings=a):this._$AH=m}_$AI(e,r=this,a,s){const o=this.strings;let i=!1;if(o===void 0)e=E(this,e,r,0),i=!R(e)||e!==this._$AH&&e!==S,i&&(this._$AH=e);else{const l=e;let n,p;for(e=o[0],n=0;n<o.length-1;n++)p=E(this,l[a+n],r,n),p===S&&(p=this._$AH[n]),i||(i=!R(p)||p!==this._$AH[n]),p===m?e=m:e!==m&&(e+=(p??"")+o[n+1]),this._$AH[n]=p}i&&!s&&this.j(e)}j(e){e===m?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class Fe extends J{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===m?void 0:e}}class Ke extends J{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==m)}}class Xe extends J{constructor(e,r,a,s,o){super(e,r,a,s,o),this.type=5}_$AI(e,r=this){if((e=E(this,e,r,0)??m)===S)return;const a=this._$AH,s=e===m&&a!==m||e.capture!==a.capture||e.once!==a.once||e.passive!==a.passive,o=e!==m&&(a===m||s);s&&this.element.removeEventListener(this.name,this,a),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var r;typeof this._$AH=="function"?this._$AH.call(((r=this.options)==null?void 0:r.host)??this.element,e):this._$AH.handleEvent(e)}}class Ze{constructor(e,r,a){this.element=e,this.type=6,this._$AN=void 0,this._$AM=r,this.options=a}get _$AU(){return this._$AM._$AU}_$AI(e){E(this,e)}}const Z=M.litHtmlPolyfillSupport;Z==null||Z(N,L),(M.litHtmlVersions??(M.litHtmlVersions=[])).push("3.3.2");const Se=(t,e,r)=>{const a=(r==null?void 0:r.renderBefore)??e;let s=a._$litPart$;if(s===void 0){const o=(r==null?void 0:r.renderBefore)??null;a._$litPart$=s=new L(e.insertBefore(I(),o),o,void 0,r??{})}return s._$AI(t),s};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */function y(t){return tt({...t,state:!0,attribute:!1})}const rt={common:{getStarted:"开始使用",learnMore:"了解更多",viewOnGithub:"GitHub 仓库"},navbar:{links:{features:"功能",runtime:"运行时",ecosystem:"生态",gateway:"网关",workflow:"工作流",extensions:"扩展",comparison:"对比"},cta:"开始使用"},hero:{badge:"持续进化的 Pi Runtime",title:{part1:"把 AI 编程变成",accent:"可编程系统",part2:""},description:"Pi 不只是聊天窗口：它把代码检索、上下文 checkpoint、角色记忆、原生 GAPP 界面、Provider 可观测性和 Gateway 编排放进同一个可扩展运行时。",cta:{primary:"开始使用",secondary:"阅读文档"},stats:{commands:"持久上下文",extensions:"原生生成式 UI",productivity:"端到端可观测"}},features:{label:"运行时能力",title:"从上下文到交付，一条可观察链路",subtitle:"检索真实代码路径，保存可恢复上下文，用扩展和 GAPP 增强交互，并把验证证据留在同一会话里。",workflow:{title:"证据驱动工作流",desc:"先定位真实实现，再形成计划、执行最小修改、运行验证并交付证据；流程随任务复杂度伸缩，而不是固定阶段表演。",features:["先读真实调用链，再动代码","checkpoint / compact 保留关键上下文","测试、diff、状态一起验证","工具与扩展按任务动态组合"],metrics:{tasks:"上下文标记",success:"工作树状态",active:"Provider 追踪"}},skills:{title:"按需技能与工具",desc:"语义检索、AST、浏览器、设计、诊断、文档与自动化能力按任务加载。",tags:["ace-tool","ast-grep","codemap","web-browser","diagnose"]},subagents:{title:"角色与长期记忆",desc:"角色配置、记忆检索与 viewer 贯穿会话，而不是每次从零开始。",agents:["角色","记忆","召回","整理","导出","Viewer","标签","向量","场景","提示","服务","适配"]},search:{title:"代码搜索",desc:"自然语言到精确位置。三层搜索，零遗漏。",example:'pi /search "认证中间件"'},gateway:{title:"多通道网关",desc:"一个服务支持 Telegram、Discord、WebChat、OpenAI API。",code:"await gateway.route({ channel: 'telegram', session: uuid() });"}},gateway:{label:"网关",title:"把 Pi 运行时分发到更多入口",subtitle:"Gateway 用 RPC worker pool、会话路由和插件管线把同一套 Pi 能力接到 Web、API 与消息通道，同时保持 worker 启动可控。",layers:{channels:{title:"通道",desc:"Telegram · Discord · WebChat · API"},pipeline:{title:"管线",desc:"分发 → 去重 → 解析 → 处理"},plugins:{title:"插件",desc:"16 钩子 · 注册表 · 冲突检测"},runtime:{title:"运行时",desc:"RPC 池 · 路由 · 定时 · 事件"},security:{title:"安全",desc:"认证 · 执行守卫 · SSRF · 白名单"}}},workflow:{label:"工作流",title:"证据驱动的工程闭环",subtitle:"不是固定五阶段，而是围绕真实代码、可恢复上下文和可复现验证形成闭环。",phases:[{num:"01",title:"定位",desc:"语义检索、精确匹配、调用链"},{num:"02",title:"建模",desc:"理解约束、选择最小改动面"},{num:"03",title:"保存",desc:"checkpoint、tag、compact 关键上下文"},{num:"04",title:"执行",desc:"精准编辑、扩展工具、GAPP 交互"},{num:"05",title:"验证",desc:"测试、diff、状态与可观测证据"}]},extensions:{label:"扩展",title:"无限扩展",subtitle:"从 CLI 命令到 TUI 组件，从网关插件到定时任务。",categories:{commands:{title:"命令",desc:"斜杠命令和快捷键"},tools:{title:"工具",desc:"可复用能力"},gateway:{title:"网关",desc:"通道集成"}}},comparison:{label:"对比",title:"不把 Agent 当一次性聊天",subtitle:"Pi 的差异在运行时：上下文能恢复、能力能扩展、行为能观察、界面能生成。",headers:{feature:"能力",pi:"Pi Agent",others:"典型工具"},rows:[{feature:"上下文生命周期",pi:"checkpoint + tag + compact",others:"会话即上下文"},{feature:"代码定位",pi:"语义 + 精确 + AST",others:"基础搜索"},{feature:"交互表面",pi:"TUI + Web + GAPP",others:"单一聊天界面"},{feature:"长期记忆",pi:"角色记忆 + 检索 + viewer",others:"临时提示词"},{feature:"可观测与分发",pi:"Provider Trace + Gateway/RPC",others:"单一接口"}]},cta:{title:"把你的 Pi 变成自己的工程系统",subtitle:"从一个可工作的 coding agent 开始，再按项目需要接入记忆、GAPP、可观测性与网关。",button:"开始使用"},footer:{tagline:"工程级 AI 编排。",links:{docs:"文档",github:"GitHub",discord:"Discord"},copyright:"精准构建。"}},st={common:{getStarted:"Get Started",learnMore:"Learn More",viewOnGithub:"View on GitHub"},navbar:{links:{features:"Features",runtime:"Runtime",ecosystem:"Ecosystem",gateway:"Gateway",workflow:"Workflow",extensions:"Extensions",comparison:"Compare"},cta:"Get Started"},hero:{badge:"Pi Runtime, continuously evolving",title:{part1:"Make AI coding a ",accent:"programmable system",part2:""},description:"Pi is more than a chat surface: code retrieval, context checkpoints, role memory, native GAPP interfaces, provider observability, and gateway orchestration live in one extensible runtime.",cta:{primary:"Get Started",secondary:"Read Docs"},stats:{commands:"Persistent Context",extensions:"Native Generative UI",productivity:"End-to-end Observability"}},features:{label:"Runtime Capabilities",title:"One observable path from context to delivery",subtitle:"Trace real code paths, preserve recoverable context, extend the runtime with tools and GAPPs, and keep verification evidence in the same session.",workflow:{title:"Evidence-driven workflow",desc:"Locate the real implementation, model constraints, make the smallest change, verify it, and ship evidence. The loop scales with the task instead of enforcing ceremony.",features:["Read the real call path before editing","Checkpoint / compact critical context","Verify tests, diff, and worktree state together","Compose tools and extensions per task"],metrics:{tasks:"Context Tag",success:"Worktree State",active:"Provider Trace"}},skills:{title:"On-demand skills & tools",desc:"Semantic retrieval, AST, browser, design, diagnosis, docs, and automation capabilities load for the task at hand.",tags:["ace-tool","ast-grep","codemap","web-browser","diagnose"]},subagents:{title:"Roles & durable memory",desc:"Role configuration, memory retrieval, and a viewer carry knowledge across sessions instead of starting from zero.",agents:["role","memory","recall","organize","export","viewer","tags","vector","scenarios","prompt","service","adapter"]},search:{title:"Code Search",desc:"Natural language to exact location. Three layers, zero misses.",example:'pi /search "auth middleware"'},gateway:{title:"Multi-Channel Gateway",desc:"One service for Telegram, Discord, WebChat, OpenAI API.",code:"await gateway.route({ channel: 'telegram', session: uuid() });"}},gateway:{label:"Gateway",title:"Distribute the Pi runtime beyond the terminal",subtitle:"Gateway uses an RPC worker pool, session routing, and a programmable plugin pipeline to expose the same Pi capabilities through Web, APIs, and messaging channels.",layers:{channels:{title:"Channels",desc:"Telegram · Discord · WebChat · API"},pipeline:{title:"Pipeline",desc:"Dispatch → Dedup → Resolve → Process"},plugins:{title:"Plugins",desc:"16 Hooks · Registry · Conflicts"},runtime:{title:"Runtime",desc:"RPC Pool · Router · Cron · Events"},security:{title:"Security",desc:"Auth · ExecGuard · SSRF · Allowlist"}}},workflow:{label:"Workflow",title:"An evidence-driven engineering loop",subtitle:"Not a mandatory five-step ritual: a loop around real code, recoverable context, precise edits, and reproducible verification.",phases:[{num:"01",title:"Locate",desc:"Semantic retrieval, exact match, call paths"},{num:"02",title:"Model",desc:"Understand constraints, choose the smallest surface"},{num:"03",title:"Preserve",desc:"Checkpoint, tag, and compact critical context"},{num:"04",title:"Execute",desc:"Surgical edits, extension tools, GAPP interaction"},{num:"05",title:"Verify",desc:"Tests, diff, state, and observable evidence"}]},extensions:{label:"Extensions",title:"Infinite Extensibility",subtitle:"From CLI commands to TUI components, from gateway plugins to cron jobs.",categories:{commands:{title:"Commands",desc:"Slash commands and shortcuts"},tools:{title:"Tools",desc:"Reusable capabilities"},gateway:{title:"Gateway",desc:"Channel integrations"}}},comparison:{label:"Comparison",title:"An agent runtime, not disposable chat",subtitle:"Pi differs at the runtime layer: context can recover, capabilities can extend, behavior can be observed, and interfaces can be generated.",headers:{feature:"Capability",pi:"Pi Agent",others:"Typical Tools"},rows:[{feature:"Context lifecycle",pi:"checkpoint + tag + compact",others:"session-only context"},{feature:"Code location",pi:"semantic + exact + AST",others:"basic search"},{feature:"Interaction surface",pi:"TUI + Web + GAPP",others:"single chat surface"},{feature:"Durable memory",pi:"role memory + retrieval + viewer",others:"temporary prompts"},{feature:"Observe & distribute",pi:"Provider Trace + Gateway/RPC",others:"single interface"}]},cta:{title:"Turn Pi into your engineering system",subtitle:"Start with a working coding agent, then add memory, GAPPs, observability, and gateway capabilities as your project needs them.",button:"Get Started"},footer:{tagline:"Engineering-grade AI orchestration.",links:{docs:"Documentation",github:"GitHub",discord:"Discord"},copyright:"Built with precision."}},ee={"zh-CN":rt,"en-US":st},ye="pi-agent-locale";class at{constructor(){this.currentLocale="en-US",this.listeners=new Set,this.detectLocale()}detectLocale(){try{const r=localStorage.getItem(ye);if(r&&ee[r]){this.currentLocale=r;return}}catch{}(navigator.language||"").startsWith("zh")&&(this.currentLocale="zh-CN")}getCurrentLocale(){return this.currentLocale}setLocale(e){if(ee[e]&&e!==this.currentLocale){this.currentLocale=e;try{localStorage.setItem(ye,e)}catch{}document.documentElement.lang=e==="zh-CN"?"zh-CN":"en",this.listeners.forEach(r=>r())}}t(e){const r=e.split(".");let a=ee[this.currentLocale];for(const s of r)if(a&&typeof a=="object"&&s in a)a=a[s];else return e;return typeof a=="string"?a:e}subscribe(e){return this.listeners.add(e),()=>{this.listeners.delete(e)}}getAvailableLocales(){return[{code:"en-US",label:"EN"},{code:"zh-CN",label:"中文"}]}}const c=new at;var ot=Object.defineProperty,it=Object.getOwnPropertyDescriptor,F=(t,e,r,a)=>{for(var s=a>1?void 0:a?it(e,r):e,o=t.length-1,i;o>=0;o--)(i=t[o])&&(s=(a?i(e,r,s):i(s))||s);return a&&s&&ot(e,r,s),s};const xe=[{key:"features",id:"features"},{key:"runtime",id:"runtime"},{key:"ecosystem",id:"ecosystem"},{key:"extensions",id:"extensions"},{key:"comparison",id:"comparison"}],te="https://github.com/Dwsy/agent";let O=class extends g{constructor(){super(...arguments),this.locale=c.getCurrentLocale(),this.menuOpen=!1,this.activeId="",this._ghIcon=h`<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  `;F([y()],O.prototype,"locale",2);F([y()],O.prototype,"menuOpen",2);F([y()],O.prototype,"activeId",2);O=F([f("pi-navbar")],O);var nt=Object.defineProperty,lt=Object.getOwnPropertyDescriptor,Ee=(t,e,r,a)=>{for(var s=a>1?void 0:a?lt(e,r):e,o=t.length-1,i;o>=0;o--)(i=t[o])&&(s=(a?i(e,r,s):i(s))||s);return a&&s&&nt(e,r,s),s};let j=class extends g{constructor(){super(...arguments),this.locale=c.getCurrentLocale()}connectedCallback(){super.connectedCallback(),this._unsub=c.subscribe(()=>{this.locale=c.getCurrentLocale()})}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._unsub)==null||t.call(this)}t(t){return c.t(t)}render(){const t=c.t.bind(c);return h`
  ...
  `;Ee([y()],j.prototype,"locale",2);j=Ee([f("hero-section")],j);var ct=Object.defineProperty,dt=Object.getOwnPropertyDescriptor,Oe=(t,e,r,a)=>{for(var s=a>1?void 0:a?dt(e,r):e,o=t.length-1,i;o>=0;o--)(i=t[o])&&(s=(a?i(e,r,s):i(s))||s);return a&&s&&ct(e,r,s),s};let B=class extends g{constructor(){super(...arguments),this.locale=c.getCurrentLocale()}connectedCallback(){super.connectedCallback(),this._unsub=c.subscribe(()=>{this.locale=c.getCurrentLocale()})}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._unsub)==null||t.call(this)}_handleMouseMove(t){const e=t.currentTarget,r=e.getBoundingClientRect(),a=(t.clientX-r.left)/r.width*100,s=(t.clientY-r.top)/r.height*100;e.style.setProperty("--mouse-x",`${a}%`),e.style.setProperty("--mouse-y",`${s}%`)}render(){const t=a=>c.t(a),e=c.getCurrentLocale()==="zh-CN",r=e?["角色","记忆","召回","整理","标签","向量","Viewer","服务","适配","导出","场景","提示"]:["ROLE","MEM","RECALL","ORG","TAG","VEC","VIEW","SVC","ADAPT","EXP","SCN","PROMPT"];return h`
        ...
        <div class="inner">
          ...
          <div class="grid">
            ...
            <div class="card span-6 row-4" @mousemove=${this._handleMouseMove}>
              ...
              <ul class="features">
                ${[0,1,2,3].map(a=>h`<li class="feature">${t(`features.workflow.features.${a}`)}</li>`)}
              </ul>
            ...
            <div class="card span-3 row-2" @mousemove=${this._handleMouseMove}>
              ...
              <div class="skill-tags">
                ${[0,1,2,3,4].map(a=>h`<span class="skill-tag">${t(`features.skills.tags.${a}`)}</span>`)}
              </div>
            </div>
            ...
            <div class="card span-3 row-2" @mousemove=${this._handleMouseMove}>
              ...
              <div class="agent-grid">
                ${r.map((a,s)=>h`
                  <div class="agent-cell ${s<5?"active":""}">${a}</div>
                `)}
              </div>
            </div>
  ...
  `;Oe([y()],B.prototype,"locale",2);B=Oe([f("bento-grid")],B);var pt=Object.defineProperty,ht=Object.getOwnPropertyDescriptor,Te=(t,e,r,a)=>{for(var s=a>1?void 0:a?ht(e,r):e,o=t.length-1,i;o>=0;o--)(i=t[o])&&(s=(a?i(e,r,s):i(s))||s);return a&&s&&pt(e,r,s),s};let W=class extends g{constructor(){super(...arguments),this.locale=c.getCurrentLocale()}connectedCallback(){super.connectedCallback(),this.unsubscribe=c.subscribe(()=>{this.locale=c.getCurrentLocale()})}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this.unsubscribe)==null||t.call(this)}render(){const t=this.locale==="zh-CN";return h`
  ...
  `;Te([y()],W.prototype,"locale",2);W=Te([f("runtime-system-scene")],W);var mt=Object.defineProperty,ut=Object.getOwnPropertyDescriptor,ze=(t,e,r,a)=>{for(var s=a>1?void 0:a?ut(e,r):e,o=t.length-1,i;o>=0;o--)(i=t[o])&&(s=(a?i(e,r,s):i(s))||s);return a&&s&&mt(e,r,s),s};let V=class extends g{constructor(){super(...arguments),this.locale=c.getCurrentLocale()}connectedCallback(){super.connectedCallback(),this.unsubscribe=c.subscribe(()=>{this.locale=c.getCurrentLocale()})}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this.unsubscribe)==null||t.call(this)}render(){const t=this.locale==="zh-CN";return h`
  ...
  `;ze([y()],V.prototype,"locale",2);V=ze([f("companion-ecosystem-scene")],V);var gt=Object.defineProperty,ft=Object.getOwnPropertyDescriptor,Me=(t,e,r,a)=>{for(var s=a>1?void 0:a?ft(e,r):e,o=t.length-1,i;o>=0;o--)(i=t[o])&&(s=(a?i(e,r,s):i(s))||s);return a&&s&&gt(e,r,s),s};let Y=class extends g{constructor(){super(...arguments),this.locale=c.getCurrentLocale()}connectedCallback(){super.connectedCallback(),this.unsubscribe=c.subscribe(()=>{this.locale=c.getCurrentLocale()})}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this.unsubscribe)==null||t.call(this)}render(){const t=this.locale==="zh-CN";return h`
  ...
  `;Me([y()],Y.prototype,"locale",2);Y=Me([f("extend-and-prove-scene")],Y);var bt=Object.defineProperty,vt=Object.getOwnPropertyDescriptor,Ie=(t,e,r,a)=>{for(var s=a>1?void 0:a?vt(e,r):e,o=t.length-1,i;o>=0;o--)(i=t[o])&&(s=(a?i(e,r,s):i(s))||s);return a&&s&&bt(e,r,s),s};let q=class extends g{constructor(){super(...arguments),this.locale=c.getCurrentLocale()}connectedCallback(){super.connectedCallback(),this._unsub=c.subscribe(()=>{this.locale=c.getCurrentLocale()})}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._unsub)==null||t.call(this)}t(t){return c.t(t)}render(){const t=c.t.bind(c);return h`
  ...
  `;Ie([y()],q.prototype,"locale",2);q=Ie([f("cta-section")],q);var yt=Object.getOwnPropertyDescriptor,xt=(t,e,r,a)=>{for(var s=a>1?void 0:a?yt(e,r):e,o=t.length-1,i;o>=0;o--)(i=t[o])&&(s=i(s)||s);return s};let re=class extends g{render(){return h`
      <footer class="footer">
        <div class="inner">
          <div class="brand">
  ...
  `;re=xt([f("pi-footer")],re);var wt=Object.getOwnPropertyDescriptor,$t=(t,e,r,a)=>{for(var s=a>1?void 0:a?wt(e,r):e,o=t.length-1,i;o>=0;o--)(i=t[o])&&(s=i(s)||s);return s};let se=class extends g{constructor(){super(...arguments),this.particles=[],this.PARTICLE_COUNT=30,this.CONNECTION_DISTANCE=150,this.MAX_CONNECTIONS=3,this.animate=()=>{!this.ctx||!this.canvas||(this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height),this.particles.forEach((t,e)=>{t.x+=t.vx,t.y+=t.vy,(t.x<0||t.x>this.canvas.width)&&(t.vx*=-1),(t.y<0||t.y>this.canvas.height)&&(t.vy*=-1),this.ctx.beginPath(),this.ctx.arc(t.x,t.y,t.radius,0,Math.PI*2),this.ctx.fillStyle=`rgba(16, 185, 129, ${t.opacity})`,this.ctx.fill();let r=0;for(let a=e+1;a<this.particles.length&&!(r>=this.MAX_CONNECTIONS);a++){const s=this.particles[a],o=t.x-s.x,i=t.y-s.y,l=Math.sqrt(o*o+i*i);if(l<this.CONNECTION_DISTANCE){const n=(1-l/this.CONNECTION_DISTANCE)*.15;this.ctx.beginPath(),this.ctx.moveTo(t.x,t.y),this.ctx.lineTo(s.x,s.y),this.ctx.strokeStyle=`rgba(16, 185, 129, ${n})`,this.ctx.lineWidth=.5,this.ctx.stroke(),r++}}}),this.animationId=requestAnimationFrame(this.animate))}}firstUpdated(){this.canvas=this.renderRoot.querySelector("canvas"),this.canvas&&(this.ctx=this.canvas.getContext("2d")||void 0,this.ctx&&(this.setupCanvas(),this.initParticles(),this.animate(),this.resizeObserver=new ResizeObserver(()=>{this.setupCanvas()}),this.resizeObserver.observe(this.canvas)))}setupCanvas(){var e;if(!this.canvas)return;const t=(e=this.canvas.parentElement)==null?void 0:e.getBoundingClientRect();t&&(this.canvas.width=t.width,this.canvas.height=t.height)}initParticles(){if(this.canvas){this.particles=[];for(let t=0;t<this.PARTICLE_COUNT;t++)this.particles.push({x:Math.random()*this.canvas.width,y:Math.random()*this.canvas.height,vx:(Math.random()-.5)*.3,vy:(Math.random()-.5)*.3,radius:Math.random()*1.5+.5,opacity:Math.random()*.3+.1})}}disconnectedCallback(){var t;super.disconnectedCallback(),this.animationId&&cancelAnimationFrame(this.animationId),(t=this.resizeObserver)==null||t.disconnect()}render(){return h`<canvas></canvas>`}};se.styles=v`
    :host {
      display: block;
      position: fixed;
      inset: 0;
  ...
  `;se=$t([f("canvas-background")],se);var kt=Object.getOwnPropertyDescriptor,_t=(t,e,r,a)=>{for(var s=a>1?void 0:a?kt(e,r):e,o=t.length-1,i;o>=0;o--)(i=t[o])&&(s=i(s)||s);return s};let we=class extends g{createRenderRoot(){return this}render(){return h`
