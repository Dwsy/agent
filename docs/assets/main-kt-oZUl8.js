 ...
 */const L=globalThis,oe=L.ShadowRoot&&(L.ShadyCSS===void 0||L.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,se=Symbol(),ne=new WeakMap;let ke=class{constructor(e,r,s){if(this._$cssResult$=!0,s!==se)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=r}get styleSheet(){let e=this.o;const r=this.t;if(oe&&e===void 0){const s=r!==void 0&&r.length===1;s&&(e=ne.get(r)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&ne.set(r,e))}return e}toString(){return this.cssText}};const ze=t=>new ke(typeof t=="string"?t:t+"",void 0,se),x=(t,...e)=>{const r=t.length===1?t[0]:e.reduce((s,o,i)=>s+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+t[i+1],t[0]);return new ke(r,t,se)},Me=(t,e)=>{if(oe)t.adoptedStyleSheets=e.map(r=>r instanceof CSSStyleSheet?r:r.styleSheet);else for(const r of e){const s=document.createElement("style"),o=L.litNonce;o!==void 0&&s.setAttribute("nonce",o),s.textContent=r.cssText,t.appendChild(s)}},ce=oe?t=>t:t=>t instanceof CSSStyleSheet?(e=>{let r="";for(const s of e.cssRules)r+=s.cssText;return ze(r)})(t):t;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:Ne,defineProperty:Re,getOwnPropertyDescriptor:Ue,getOwnPropertyNames:Ge,getOwnPropertySymbols:Le,getPrototypeOf:De}=Object,w=globalThis,le=w.trustedTypes,He=le?le.emptyScript:"",Y=w.reactiveElementPolyfillSupport,I=(t,e)=>t,D={toAttribute(t,e){switch(e){case Boolean:t=t?He:null;break;case Object:case Array:t=t==null?t:JSON.stringify(t)}return t},fromAttribute(t,e){let r=t;switch(e){case Boolean:r=t!==null;break;case Number:r=t===null?null:Number(t);break;case Object:case Array:try{r=JSON.parse(t)}catch{r=null}}return r}},ie=(t,e)=>!Ne(t,e),de={attribute:!0,type:String,converter:D,reflect:!1,useDefault:!1,hasChanged:ie};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),w.litPropertyMetadata??(w.litPropertyMetadata=new WeakMap);let C=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??(this.l=[])).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,r=de){if(r.state&&(r.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((r=Object.create(r)).wrapped=!0),this.elementProperties.set(e,r),!r.noAccessor){const s=Symbol(),o=this.getPropertyDescriptor(e,s,r);o!==void 0&&Re(this.prototype,e,o)}}static getPropertyDescriptor(e,r,s){const{get:o,set:i}=Ue(this.prototype,e)??{get(){return this[r]},set(a){this[r]=a}};return{get:o,set(a){const c=o==null?void 0:o.call(this);i==null||i.call(this,a),this.requestUpdate(e,c,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??de}static _$Ei(){if(this.hasOwnProperty(I("elementProperties")))return;const e=De(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(I("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(I("properties"))){const r=this.properties,s=[...Ge(r),...Le(r)];for(const o of s)this.createProperty(o,r[o])}const e=this[Symbol.metadata];if(e!==null){const r=litPropertyMetadata.get(e);if(r!==void 0)for(const[s,o]of r)this.elementProperties.set(s,o)}this._$Eh=new Map;for(const[r,s]of this.elementProperties){const o=this._$Eu(r,s);o!==void 0&&this._$Eh.set(o,r)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const r=[];if(Array.isArray(e)){const s=new Set(e.flat(1/0).reverse());for(const o of s)r.unshift(ce(o))}else e!==void 0&&r.push(ce(e));return r}static _$Eu(e,r){const s=r.attribute;return s===!1?void 0:typeof s=="string"?s:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var e;this._$ES=new Promise(r=>this.enableUpdating=r),this._$AL=new Map,this._$E_(),this.requestUpdate(),(e=this.constructor.l)==null||e.forEach(r=>r(this))}addController(e){var r;(this._$EO??(this._$EO=new Set)).add(e),this.renderRoot!==void 0&&this.isConnected&&((r=e.hostConnected)==null||r.call(e))}removeController(e){var r;(r=this._$EO)==null||r.delete(e)}_$E_(){const e=new Map,r=this.constructor.elementProperties;for(const s of r.keys())this.hasOwnProperty(s)&&(e.set(s,this[s]),delete this[s]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Me(e,this.constructor.elementStyles),e}connectedCallback(){var e;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$EO)==null||e.forEach(r=>{var s;return(s=r.hostConnected)==null?void 0:s.call(r)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$EO)==null||e.forEach(r=>{var s;return(s=r.hostDisconnected)==null?void 0:s.call(r)})}attributeChangedCallback(e,r,s){this._$AK(e,s)}_$ET(e,r){var i;const s=this.constructor.elementProperties.get(e),o=this.constructor._$Eu(e,s);if(o!==void 0&&s.reflect===!0){const a=(((i=s.converter)==null?void 0:i.toAttribute)!==void 0?s.converter:D).toAttribute(r,s.type);this._$Em=e,a==null?this.removeAttribute(o):this.setAttribute(o,a),this._$Em=null}}_$AK(e,r){var i,a;const s=this.constructor,o=s._$Eh.get(e);if(o!==void 0&&this._$Em!==o){const c=s.getPropertyOptions(o),n=typeof c.converter=="function"?{fromAttribute:c.converter}:((i=c.converter)==null?void 0:i.fromAttribute)!==void 0?c.converter:D;this._$Em=o;const p=n.fromAttribute(r,c.type);this[o]=p??((a=this._$Ej)==null?void 0:a.get(o))??p,this._$Em=null}}requestUpdate(e,r,s,o=!1,i){var a;if(e!==void 0){const c=this.constructor;if(o===!1&&(i=this[e]),s??(s=c.getPropertyOptions(e)),!((s.hasChanged??ie)(i,r)||s.useDefault&&s.reflect&&i===((a=this._$Ej)==null?void 0:a.get(e))&&!this.hasAttribute(c._$Eu(e,s))))return;this.C(e,r,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,r,{useDefault:s,reflect:o,wrapped:i},a){s&&!(this._$Ej??(this._$Ej=new Map)).has(e)&&(this._$Ej.set(e,a??r??this[e]),i!==!0||a!==void 0)||(this._$AL.has(e)||(this.hasUpdated||s||(r=void 0),this._$AL.set(e,r)),o===!0&&this._$Em!==e&&(this._$Eq??(this._$Eq=new Set)).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(r){Promise.reject(r)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var s;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[i,a]of this._$Ep)this[i]=a;this._$Ep=void 0}const o=this.constructor.elementProperties;if(o.size>0)for(const[i,a]of o){const{wrapped:c}=a,n=this[i];c!==!0||this._$AL.has(i)||n===void 0||this.C(i,void 0,a,n)}}let e=!1;const r=this._$AL;try{e=this.shouldUpdate(r),e?(this.willUpdate(r),(s=this._$EO)==null||s.forEach(o=>{var i;return(i=o.hostUpdate)==null?void 0:i.call(o)}),this.update(r)):this._$EM()}catch(o){throw e=!1,this._$EM(),o}e&&this._$AE(r)}willUpdate(e){}_$AE(e){var r;(r=this._$EO)==null||r.forEach(s=>{var o;return(o=s.hostUpdated)==null?void 0:o.call(s)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&(this._$Eq=this._$Eq.forEach(r=>this._$ET(r,this[r]))),this._$EM()}updated(e){}firstUpdated(e){}};C.elementStyles=[],C.shadowRootOptions={mode:"open"},C[I("elementProperties")]=new Map,C[I("finalized")]=new Map,Y==null||Y({ReactiveElement:C}),(w.reactiveElementVersions??(w.reactiveElementVersions=[])).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const z=globalThis,pe=t=>t,H=z.trustedTypes,he=H?H.createPolicy("lit-html",{createHTML:t=>t}):void 0,$e="$lit$",y=`lit$${Math.random().toFixed(9).slice(2)}$`,_e="?"+y,je=`<${_e}>`,A=document,M=()=>A.createComment(""),N=t=>t===null||typeof t!="object"&&typeof t!="function",ae=Array.isArray,Be=t=>ae(t)||typeof(t==null?void 0:t[Symbol.iterator])=="function",F=`[ 	
\f\r]`,T=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,me=/-->/g,ge=/>/g,$=RegExp(`>|${F}(?:([^\\s"'>=/]+)(${F}*=${F}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),fe=/'/g,ue=/"/g,Pe=/^(?:script|style|textarea|title)$/i,We=t=>(e,...r)=>({_$litType$:t,strings:e,values:r}),h=We(1),S=Symbol.for("lit-noChange"),m=Symbol.for("lit-nothing"),be=new WeakMap,_=A.createTreeWalker(A,129);function Ae(t,e){if(!ae(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return he!==void 0?he.createHTML(e):e}const Je=(t,e)=>{const r=t.length-1,s=[];let o,i=e===2?"<svg>":e===3?"<math>":"",a=T;for(let c=0;c<r;c++){const n=t[c];let p,g,l=-1,u=0;for(;u<n.length&&(a.lastIndex=u,g=a.exec(n),g!==null);)u=a.lastIndex,a===T?g[1]==="!--"?a=me:g[1]!==void 0?a=ge:g[2]!==void 0?(Pe.test(g[2])&&(o=RegExp("</"+g[2],"g")),a=$):g[3]!==void 0&&(a=$):a===$?g[0]===">"?(a=o??T,l=-1):g[1]===void 0?l=-2:(l=a.lastIndex-g[2].length,p=g[1],a=g[3]===void 0?$:g[3]==='"'?ue:fe):a===ue||a===fe?a=$:a===me||a===ge?a=T:(a=$,o=void 0);const v=a===$&&t[c+1].startsWith("/>")?" ":"";i+=a===T?n+je:l>=0?(s.push(p),n.slice(0,l)+$e+n.slice(l)+y+v):n+y+(l===-2?c:v)}return[Ae(t,i+(t[r]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),s]};class R{constructor({strings:e,_$litType$:r},s){let o;this.parts=[];let i=0,a=0;const c=e.length-1,n=this.parts,[p,g]=Je(e,r);if(this.el=R.createElement(p,s),_.currentNode=this.el.content,r===2||r===3){const l=this.el.content.firstChild;l.replaceWith(...l.childNodes)}for(;(o=_.nextNode())!==null&&n.length<c;){if(o.nodeType===1){if(o.hasAttributes())for(const l of o.getAttributeNames())if(l.endsWith($e)){const u=g[a++],v=o.getAttribute(l).split(y),G=/([.?@])?(.*)/.exec(u);n.push({type:1,index:i,name:G[2],strings:v,ctor:G[1]==="."?qe:G[1]==="?"?Ke:G[1]==="@"?Ye:q}),o.removeAttribute(l)}else l.startsWith(y)&&(n.push({type:6,index:i}),o.removeAttribute(l));if(Pe.test(o.tagName)){const l=o.textContent.split(y),u=l.length-1;if(u>0){o.textContent=H?H.emptyScript:"";for(let v=0;v<u;v++)o.append(l[v],M()),_.nextNode(),n.push({type:2,index:++i});o.append(l[u],M())}}}else if(o.nodeType===8)if(o.data===_e)n.push({type:2,index:i});else{let l=-1;for(;(l=o.data.indexOf(y,l+1))!==-1;)n.push({type:7,index:i}),l+=y.length-1}i++}}static createElement(e,r){const s=A.createElement("template");return s.innerHTML=e,s}}function E(t,e,r=t,s){var a,c;if(e===S)return e;let o=s!==void 0?(a=r._$Co)==null?void 0:a[s]:r._$Cl;const i=N(e)?void 0:e._$litDirective$;return(o==null?void 0:o.constructor)!==i&&((c=o==null?void 0:o._$AO)==null||c.call(o,!1),i===void 0?o=void 0:(o=new i(t),o._$AT(t,r,s)),s!==void 0?(r._$Co??(r._$Co=[]))[s]=o:r._$Cl=o),o!==void 0&&(e=E(t,o._$AS(t,e.values),o,s)),e}class Ve{constructor(e,r){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=r}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:r},parts:s}=this._$AD,o=((e==null?void 0:e.creationScope)??A).importNode(r,!0);_.currentNode=o;let i=_.nextNode(),a=0,c=0,n=s[0];for(;n!==void 0;){if(a===n.index){let p;n.type===2?p=new U(i,i.nextSibling,this,e):n.type===1?p=new n.ctor(i,n.name,n.strings,this,e):n.type===6&&(p=new Fe(i,this,e)),this._$AV.push(p),n=s[++c]}a!==(n==null?void 0:n.index)&&(i=_.nextNode(),a++)}return _.currentNode=A,o}p(e){let r=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,r),r+=s.strings.length-2):s._$AI(e[r])),r++}}class U{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,r,s,o){this.type=2,this._$AH=m,this._$AN=void 0,this._$AA=e,this._$AB=r,this._$AM=s,this.options=o,this._$Cv=(o==null?void 0:o.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const r=this._$AM;return r!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=r.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,r=this){e=E(this,e,r),N(e)?e===m||e==null||e===""?(this._$AH!==m&&this._$AR(),this._$AH=m):e!==this._$AH&&e!==S&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Be(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==m&&N(this._$AH)?this._$AA.nextSibling.data=e:this.T(A.createTextNode(e)),this._$AH=e}$(e){var i;const{values:r,_$litType$:s}=e,o=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=R.createElement(Ae(s.h,s.h[0]),this.options)),s);if(((i=this._$AH)==null?void 0:i._$AD)===o)this._$AH.p(r);else{const a=new Ve(o,this),c=a.u(this.options);a.p(r),this.T(c),this._$AH=a}}_$AC(e){let r=be.get(e.strings);return r===void 0&&be.set(e.strings,r=new R(e)),r}k(e){ae(this._$AH)||(this._$AH=[],this._$AR());const r=this._$AH;let s,o=0;for(const i of e)o===r.length?r.push(s=new U(this.O(M()),this.O(M()),this,this.options)):s=r[o],s._$AI(i),o++;o<r.length&&(this._$AR(s&&s._$AB.nextSibling,o),r.length=o)}_$AR(e=this._$AA.nextSibling,r){var s;for((s=this._$AP)==null?void 0:s.call(this,!1,!0,r);e!==this._$AB;){const o=pe(e).nextSibling;pe(e).remove(),e=o}}setConnected(e){var r;this._$AM===void 0&&(this._$Cv=e,(r=this._$AP)==null||r.call(this,e))}}class q{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,r,s,o,i){this.type=1,this._$AH=m,this._$AN=void 0,this.element=e,this.name=r,this._$AM=o,this.options=i,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=m}_$AI(e,r=this,s,o){const i=this.strings;let a=!1;if(i===void 0)e=E(this,e,r,0),a=!N(e)||e!==this._$AH&&e!==S,a&&(this._$AH=e);else{const c=e;let n,p;for(e=i[0],n=0;n<i.length-1;n++)p=E(this,c[s+n],r,n),p===S&&(p=this._$AH[n]),a||(a=!N(p)||p!==this._$AH[n]),p===m?e=m:e!==m&&(e+=(p??"")+i[n+1]),this._$AH[n]=p}a&&!o&&this.j(e)}j(e){e===m?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class qe extends q{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===m?void 0:e}}class Ke extends q{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==m)}}class Ye extends q{constructor(e,r,s,o,i){super(e,r,s,o,i),this.type=5}_$AI(e,r=this){if((e=E(this,e,r,0)??m)===S)return;const s=this._$AH,o=e===m&&s!==m||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,i=e!==m&&(s===m||o);o&&this.element.removeEventListener(this.name,this,s),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var r;typeof this._$AH=="function"?this._$AH.call(((r=this.options)==null?void 0:r.host)??this.element,e):this._$AH.handleEvent(e)}}class Fe{constructor(e,r,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=r,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){E(this,e)}}const X=z.litHtmlPolyfillSupport;X==null||X(R,U),(z.litHtmlVersions??(z.litHtmlVersions=[])).push("3.3.2");const Ce=(t,e,r)=>{const s=(r==null?void 0:r.renderBefore)??e;let o=s._$litPart$;if(o===void 0){const i=(r==null?void 0:r.renderBefore)??null;s._$litPart$=o=new U(e.insertBefore(M(),i),i,void 0,r??{})}return o._$AI(t),o};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const P=globalThis;class f extends C{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var r;const e=super.createRenderRoot();return(r=this.renderOptions).renderBefore??(r.renderBefore=e.firstChild),e}update(e){const r=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Ce(r,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return S}}var xe;f._$litElement$=!0,f.finalized=!0,(xe=P.litElementHydrateSupport)==null||xe.call(P,{LitElement:f});const Z=P.litElementPolyfillSupport;Z==null||Z({LitElement:f});(P.litElementVersions??(P.litElementVersions=[])).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */function k(t){return Qe({...t,state:!0,attribute:!1})}const et={common:{getStarted:"开始使用",learnMore:"了解更多",viewOnGithub:"GitHub 仓库"},navbar:{links:{features:"功能",runtime:"运行时",ecosystem:"生态",gateway:"网关",workflow:"工作流",extensions:"扩展",comparison:"对比"},cta:"开始使用"},hero:{badge:"持续进化的 Pi Runtime",title:{part1:"把 AI 编程变成",accent:"可编程系统",part2:""},description:"Pi 不只是聊天窗口：它把代码检索、上下文 checkpoint、角色记忆、原生 GAPP 界面、Provider 可观测性和 Gateway 编排放进同一个可扩展运行时。",cta:{primary:"开始使用",secondary:"阅读文档"},stats:{commands:"持久上下文",extensions:"原生生成式 UI",productivity:"端到端可观测"}},features:{label:"运行时能力",title:"从上下文到交付，一条可观察链路",subtitle:"检索真实代码路径，保存可恢复上下文，用扩展和 GAPP 增强交互，并把验证证据留在同一会话里。",workflow:{title:"证据驱动工作流",desc:"先定位真实实现，再形成计划、执行最小修改、运行验证并交付证据；流程随任务复杂度伸缩，而不是固定阶段表演。",features:["先读真实调用链，再动代码","checkpoint / compact 保留关键上下文","测试、diff、状态一起验证","工具与扩展按任务动态组合"],metrics:{tasks:"上下文标记",success:"工作树状态",active:"Provider 追踪"}},skills:{title:"按需技能与工具",desc:"语义检索、AST、浏览器、设计、诊断、文档与自动化能力按任务加载。",tags:["ace-tool","ast-grep","codemap","web-browser","diagnose"]},subagents:{title:"角色与长期记忆",desc:"角色配置、记忆检索与 viewer 贯穿会话，而不是每次从零开始。",agents:["角色","记忆","召回","整理","导出","Viewer","标签","向量","场景","提示","服务","适配"]},search:{title:"代码搜索",desc:"自然语言到精确位置。三层搜索，零遗漏。",example:'pi /search "认证中间件"'},gateway:{title:"多通道网关",desc:"一个服务支持 Telegram、Discord、WebChat、OpenAI API。",code:"await gateway.route({ channel: 'telegram', session: uuid() });"}},gateway:{label:"网关",title:"把 Pi 运行时分发到更多入口",subtitle:"Gateway 用 RPC worker pool、会话路由和插件管线把同一套 Pi 能力接到 Web、API 与消息通道，同时保持 worker 启动可控。",layers:{channels:{title:"通道",desc:"Telegram · Discord · WebChat · API"},pipeline:{title:"管线",desc:"分发 → 去重 → 解析 → 处理"},plugins:{title:"插件",desc:"16 钩子 · 注册表 · 冲突检测"},runtime:{title:"运行时",desc:"RPC 池 · 路由 · 定时 · 事件"},security:{title:"安全",desc:"认证 · 执行守卫 · SSRF · 白名单"}}},workflow:{label:"工作流",title:"证据驱动的工程闭环",subtitle:"不是固定五阶段，而是围绕真实代码、可恢复上下文和可复现验证形成闭环。",phases:[{num:"01",title:"定位",desc:"语义检索、精确匹配、调用链"},{num:"02",title:"建模",desc:"理解约束、选择最小改动面"},{num:"03",title:"保存",desc:"checkpoint、tag、compact 关键上下文"},{num:"04",title:"执行",desc:"精准编辑、扩展工具、GAPP 交互"},{num:"05",title:"验证",desc:"测试、diff、状态与可观测证据"}]},extensions:{label:"扩展",title:"无限扩展",subtitle:"从 CLI 命令到 TUI 组件，从网关插件到定时任务。",categories:{commands:{title:"命令",desc:"斜杠命令和快捷键"},tools:{title:"工具",desc:"可复用能力"},gateway:{title:"网关",desc:"通道集成"}}},comparison:{label:"对比",title:"不把 Agent 当一次性聊天",subtitle:"Pi 的差异在运行时：上下文能恢复、能力能扩展、行为能观察、界面能生成。",headers:{feature:"能力",pi:"Pi Agent",others:"典型工具"},rows:[{feature:"上下文生命周期",pi:"checkpoint + tag + compact",others:"会话即上下文"},{feature:"代码定位",pi:"语义 + 精确 + AST",others:"基础搜索"},{feature:"交互表面",pi:"TUI + Web + GAPP",others:"单一聊天界面"},{feature:"长期记忆",pi:"角色记忆 + 检索 + viewer",others:"临时提示词"},{feature:"可观测与分发",pi:"Provider Trace + Gateway/RPC",others:"单一接口"}]},cta:{title:"把你的 Pi 变成自己的工程系统",subtitle:"从一个可工作的 coding agent 开始，再按项目需要接入记忆、GAPP、可观测性与网关。",button:"开始使用"},footer:{tagline:"工程级 AI 编排。",links:{docs:"文档",github:"GitHub",discord:"Discord"},copyright:"精准构建。"}},tt={common:{getStarted:"Get Started",learnMore:"Learn More",viewOnGithub:"View on GitHub"},navbar:{links:{features:"Features",runtime:"Runtime",ecosystem:"Ecosystem",gateway:"Gateway",workflow:"Workflow",extensions:"Extensions",comparison:"Compare"},cta:"Get Started"},hero:{badge:"Pi Runtime, continuously evolving",title:{part1:"Make AI coding a ",accent:"programmable system",part2:""},description:"Pi is more than a chat surface: code retrieval, context checkpoints, role memory, native GAPP interfaces, provider observability, and gateway orchestration live in one extensible runtime.",cta:{primary:"Get Started",secondary:"Read Docs"},stats:{commands:"Persistent Context",extensions:"Native Generative UI",productivity:"End-to-end Observability"}},features:{label:"Runtime Capabilities",title:"One observable path from context to delivery",subtitle:"Trace real code paths, preserve recoverable context, extend the runtime with tools and GAPPs, and keep verification evidence in the same session.",workflow:{title:"Evidence-driven workflow",desc:"Locate the real implementation, model constraints, make the smallest change, verify it, and ship evidence. The loop scales with the task instead of enforcing ceremony.",features:["Read the real call path before editing","Checkpoint / compact critical context","Verify tests, diff, and worktree state together","Compose tools and extensions per task"],metrics:{tasks:"Context Tag",success:"Worktree State",active:"Provider Trace"}},skills:{title:"On-demand skills & tools",desc:"Semantic retrieval, AST, browser, design, diagnosis, docs, and automation capabilities load for the task at hand.",tags:["ace-tool","ast-grep","codemap","web-browser","diagnose"]},subagents:{title:"Roles & durable memory",desc:"Role configuration, memory retrieval, and a viewer carry knowledge across sessions instead of starting from zero.",agents:["role","memory","recall","organize","export","viewer","tags","vector","scenarios","prompt","service","adapter"]},search:{title:"Code Search",desc:"Natural language to exact location. Three layers, zero misses.",example:'pi /search "auth middleware"'},gateway:{title:"Multi-Channel Gateway",desc:"One service for Telegram, Discord, WebChat, OpenAI API.",code:"await gateway.route({ channel: 'telegram', session: uuid() });"}},gateway:{label:"Gateway",title:"Distribute the Pi runtime beyond the terminal",subtitle:"Gateway uses an RPC worker pool, session routing, and a programmable plugin pipeline to expose the same Pi capabilities through Web, APIs, and messaging channels.",layers:{channels:{title:"Channels",desc:"Telegram · Discord · WebChat · API"},pipeline:{title:"Pipeline",desc:"Dispatch → Dedup → Resolve → Process"},plugins:{title:"Plugins",desc:"16 Hooks · Registry · Conflicts"},runtime:{title:"Runtime",desc:"RPC Pool · Router · Cron · Events"},security:{title:"Security",desc:"Auth · ExecGuard · SSRF · Allowlist"}}},workflow:{label:"Workflow",title:"An evidence-driven engineering loop",subtitle:"Not a mandatory five-step ritual: a loop around real code, recoverable context, precise edits, and reproducible verification.",phases:[{num:"01",title:"Locate",desc:"Semantic retrieval, exact match, call paths"},{num:"02",title:"Model",desc:"Understand constraints, choose the smallest surface"},{num:"03",title:"Preserve",desc:"Checkpoint, tag, and compact critical context"},{num:"04",title:"Execute",desc:"Surgical edits, extension tools, GAPP interaction"},{num:"05",title:"Verify",desc:"Tests, diff, state, and observable evidence"}]},extensions:{label:"Extensions",title:"Infinite Extensibility",subtitle:"From CLI commands to TUI components, from gateway plugins to cron jobs.",categories:{commands:{title:"Commands",desc:"Slash commands and shortcuts"},tools:{title:"Tools",desc:"Reusable capabilities"},gateway:{title:"Gateway",desc:"Channel integrations"}}},comparison:{label:"Comparison",title:"An agent runtime, not disposable chat",subtitle:"Pi differs at the runtime layer: context can recover, capabilities can extend, behavior can be observed, and interfaces can be generated.",headers:{feature:"Capability",pi:"Pi Agent",others:"Typical Tools"},rows:[{feature:"Context lifecycle",pi:"checkpoint + tag + compact",others:"session-only context"},{feature:"Code location",pi:"semantic + exact + AST",others:"basic search"},{feature:"Interaction surface",pi:"TUI + Web + GAPP",others:"single chat surface"},{feature:"Durable memory",pi:"role memory + retrieval + viewer",others:"temporary prompts"},{feature:"Observe & distribute",pi:"Provider Trace + Gateway/RPC",others:"single interface"}]},cta:{title:"Turn Pi into your engineering system",subtitle:"Start with a working coding agent, then add memory, GAPPs, observability, and gateway capabilities as your project needs them.",button:"Get Started"},footer:{tagline:"Engineering-grade AI orchestration.",links:{docs:"Documentation",github:"GitHub",discord:"Discord"},copyright:"Built with precision."}},Q={"zh-CN":et,"en-US":tt},ve="pi-agent-locale";class rt{constructor(){this.currentLocale="en-US",this.listeners=new Set,this.detectLocale()}detectLocale(){try{const r=localStorage.getItem(ve);if(r&&Q[r]){this.currentLocale=r;return}}catch{}(navigator.language||"").startsWith("zh")&&(this.currentLocale="zh-CN")}getCurrentLocale(){return this.currentLocale}setLocale(e){if(Q[e]&&e!==this.currentLocale){this.currentLocale=e;try{localStorage.setItem(ve,e)}catch{}document.documentElement.lang=e==="zh-CN"?"zh-CN":"en",this.listeners.forEach(r=>r())}}t(e){const r=e.split(".");let s=Q[this.currentLocale];for(const o of r)if(s&&typeof s=="object"&&o in s)s=s[o];else return e;return typeof s=="string"?s:e}subscribe(e){return this.listeners.add(e),()=>{this.listeners.delete(e)}}getAvailableLocales(){return[{code:"en-US",label:"EN"},{code:"zh-CN",label:"中文"}]}}const d=new rt;var ot=Object.defineProperty,st=Object.getOwnPropertyDescriptor,K=(t,e,r,s)=>{for(var o=s>1?void 0:s?st(e,r):e,i=t.length-1,a;i>=0;i--)(a=t[i])&&(o=(s?a(e,r,o):a(o))||o);return s&&o&&ot(e,r,o),o};const ye=[{key:"features",id:"features"},{key:"runtime",id:"runtime"},{key:"ecosystem",id:"ecosystem"},{key:"extensions",id:"extensions"},{key:"comparison",id:"comparison"}],ee="https://github.com/Dwsy/agent";let O=class extends f{constructor(){super(...arguments),this.locale=d.getCurrentLocale(),this.menuOpen=!1,this.activeId="",this._ghIcon=h`<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  </svg>`}connectedCallback(){super.connectedCallback(),this._unsub=d.subscribe(()=>{this.locale=d.getCurrentLocale()}),this._setupScrollSpy(),this._scrollHandler=()=>{this.toggleAttribute("scrolled",window.scrollY>20)},window.addEventListener("scroll",this._scrollHandler,{passive:!0})}disconnectedCallback(){var t,e;super.disconnectedCallback(),(t=this._unsub)==null||t.call(this),(e=this._io)==null||e.disconnect(),this._scrollHandler&&window.removeEventListener("scroll",this._scrollHandler)}_setupScrollSpy(){const t=new Map;this._io=new IntersectionObserver(e=>{for(const o of e)o.isIntersecting?t.set(o.target.id,o.intersectionRatio):t.delete(o.target.id);let r="",s=0;t.forEach((o,i)=>{o>s&&(s=o,r=i)}),r!==this.activeId&&(this.activeId=r)},{threshold:[0,.25,.5],rootMargin:"-80px 0px -40% 0px"}),requestAnimationFrame(()=>{for(const e of ye){const r=document.getElementById(e.id);r&&this._io.observe(r)}})}t(t){return d.t(t)}_toggleLocale(){d.setLocale(this.locale==="zh-CN"?"en-US":"zh-CN")}_toggleMenu(){this.menuOpen=!this.menuOpen}_closeMenu(){this.menuOpen=!1}render(){const t=ye.map(e=>({id:e.id,label:this.t(`navbar.links.${e.key}`)}));return h`
      <nav class="nav">
        <a href="#" class="logo">
  ...
  `;K([k()],O.prototype,"locale",2);K([k()],O.prototype,"menuOpen",2);K([k()],O.prototype,"activeId",2);O=K([b("pi-navbar")],O);var it=Object.defineProperty,at=Object.getOwnPropertyDescriptor,Se=(t,e,r,s)=>{for(var o=s>1?void 0:s?at(e,r):e,i=t.length-1,a;i>=0;i--)(a=t[i])&&(o=(s?a(e,r,o):a(o))||o);return s&&o&&it(e,r,o),o};let j=class extends f{constructor(){super(...arguments),this.locale=d.getCurrentLocale()}connectedCallback(){super.connectedCallback(),this.unsubscribe=d.subscribe(()=>{this.locale=d.getCurrentLocale()})}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this.unsubscribe)==null||t.call(this)}render(){const t=this.locale==="zh-CN";return h`
      <section class="hero" id="features">
        <div class="bento">
          <article class="tile main">
            <div class="badge">${"PI ENGINEERING WORKBENCH"}</div>
            <h1>${t?h`为真实软件工程打造的 <span class="accent">Pi 工作台</span>`:h`A <span class="accent">Pi workbench</span> for real software engineering`}</h1>
            <p class="description">${t?"这是我们围绕 Pi Core 构建的一套工程工作环境：它先读懂真实代码，再管理长会话上下文与角色记忆；需要时生成 GAPP 界面、切换 Provider、通过 Gateway/RPC 分发，并用测试、diff 与工作树状态完成交付。":"An engineering environment built around Pi Core: understand the real code first, preserve long-running context and role memory, generate GAPP interfaces when useful, route across providers and Gateway/RPC, then close the loop with tests, diff, and worktree state."}</p>
            <div class="actions"><a class="action primary" href="https://github.com/Dwsy/agent" target="_blank" rel="noopener">${t?"开始使用":"Get started"} ↗</a><a class="action" href="https://github.com/Dwsy/agent#readme" target="_blank" rel="noopener">${t?"阅读文档":"Read docs"}</a></div>
            <div class="main-foot"><div><strong>${t?"读懂项目":"Understand the project"}</strong>${t?"语义检索 · AST · callers":"semantic search · AST · callers"}</div><div><strong>${t?"保持连续":"Keep continuity"}</strong>${"context · role memory · compact"}</div><div><strong>${t?"交付证据":"Ship evidence"}</strong>${"test · diff · worktree"}</div></div>
          </article>

          <article class="tile feature context"><div><div class="eyebrow">01 / Context</div><h2>${t?"上下文像 Git 一样可操作":"Operate context like Git"}</h2><p>${t?"给关键语义状态打 tag、查看 history、checkout 回任意 checkpoint；长会话 compact 后仍保留任务 handoff。":"Tag semantic states, inspect history, checkout any checkpoint, and keep the task handoff intact after long-session compaction."}</p></div><div class="tokens"><span class="token hot">tag</span><span class="token">checkout</span><span class="token">history</span><span class="token">compact</span></div></article>

          <article class="tile feature trace"><div><div class="eyebrow">02 / Observe</div><h2>Provider Trace</h2><p>${t?"观察 provider 请求/响应、模型路由与失败链路，再把测试、diff、worktree 状态接到同一条证据链。":"Inspect provider requests/responses, model routing, and failure paths, then connect tests, diff, and worktree state to the same evidence trail."}</p></div><div class="tokens"><span class="token hot">trace</span><span class="token">insights</span><span class="token">verify</span></div></article>

          <article class="tile gapp"><div class="gapp-copy"><div><div class="eyebrow">03 / Native UI</div><h2>${t?"GAPP：Agent 原生生成交互界面":"GAPP: agent-native interactive UI"}</h2><p>${t?"不是把结果塞回聊天气泡；项目图、diff、状态和操作可以直接成为会话的一部分。":"Not another chat bubble. Project maps, diffs, live state, and actions can become part of the session itself."}</p></div><div class="tokens"><span class="token hot">project map</span><span class="token">diff</span><span class="token">live state</span></div></div><div class="gapp-stage"><div class="gapp-nav"><strong>PROJECT MAP</strong>src/<br>extensions/<br>gateway/<br>roles/</div><div class="gapp-canvas"><div class="gapp-node hot">context<br>checkpoint</div><div class="gapp-node">provider<br>trace</div><div class="gapp-node">role<br>memory</div><div class="gapp-node hot">gateway<br>RPC</div></div></div></article>
          ...
          <article class="tile mini role"><div class="mark">Memory</div><strong>${t?"角色长期记忆":"Durable role memory"}</strong><span>${t?"workspace→role · daily→pending→knowledge · 向量召回 · viewer":"workspace→role · daily→pending→knowledge · vector recall · viewer"}</span></article>
          ...
          <article class="tile mini extensions"><div class="mark">Extend</div><strong>${t?"扩展 / Skill / GAPP":"Extensions / Skills / GAPP"}</strong><span>${t?"ace-tool · AST · browser · diagnose · 自定义工具与交互面":"ace-tool · AST · browser · diagnose · custom tools and UI surfaces"}</span></article>
          <article class="tile mini companions"><div class="mark">Companion</div><strong>grok-pi-tui + PSM</strong><span>${t?"Grok Pager 原生终端 · Session 搜索/树/Kanban · resume/export":"Grok Pager native TUI · session search/tree/Kanban · resume/export"}</span></article>
        </div>
      </section>
    `}};j.styles=x`
  ...
  `;Se([k()],j.prototype,"locale",2);j=Se([b("hero-section")],j);var nt=Object.defineProperty,ct=Object.getOwnPropertyDescriptor,Ee=(t,e,r,s)=>{for(var o=s>1?void 0:s?ct(e,r):e,i=t.length-1,a;i>=0;i--)(a=t[i])&&(o=(s?a(e,r,o):a(o))||o);return s&&o&&nt(e,r,o),o};let B=class extends f{constructor(){super(...arguments),this.locale=d.getCurrentLocale()}connectedCallback(){super.connectedCallback(),this.unsubscribe=d.subscribe(()=>{this.locale=d.getCurrentLocale()})}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this.unsubscribe)==null||t.call(this)}render(){const t=this.locale==="zh-CN";return h`
  ...
  `;Ee([k()],B.prototype,"locale",2);B=Ee([b("runtime-system-scene")],B);var lt=Object.defineProperty,dt=Object.getOwnPropertyDescriptor,Oe=(t,e,r,s)=>{for(var o=s>1?void 0:s?dt(e,r):e,i=t.length-1,a;i>=0;i--)(a=t[i])&&(o=(s?a(e,r,o):a(o))||o);return s&&o&&lt(e,r,o),o};let W=class extends f{constructor(){super(...arguments),this.locale=d.getCurrentLocale()}connectedCallback(){super.connectedCallback(),this.unsubscribe=d.subscribe(()=>{this.locale=d.getCurrentLocale()})}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this.unsubscribe)==null||t.call(this)}render(){const t=this.locale==="zh-CN";return h`
  ...
  `;Oe([k()],W.prototype,"locale",2);W=Oe([b("companion-ecosystem-scene")],W);var pt=Object.defineProperty,ht=Object.getOwnPropertyDescriptor,Te=(t,e,r,s)=>{for(var o=s>1?void 0:s?ht(e,r):e,i=t.length-1,a;i>=0;i--)(a=t[i])&&(o=(s?a(e,r,o):a(o))||o);return s&&o&&pt(e,r,o),o};let J=class extends f{constructor(){super(...arguments),this.locale=d.getCurrentLocale()}connectedCallback(){super.connectedCallback(),this.unsubscribe=d.subscribe(()=>{this.locale=d.getCurrentLocale()})}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this.unsubscribe)==null||t.call(this)}render(){const t=this.locale==="zh-CN";return h`
  ...
  `;Te([k()],J.prototype,"locale",2);J=Te([b("extend-and-prove-scene")],J);var mt=Object.defineProperty,gt=Object.getOwnPropertyDescriptor,Ie=(t,e,r,s)=>{for(var o=s>1?void 0:s?gt(e,r):e,i=t.length-1,a;i>=0;i--)(a=t[i])&&(o=(s?a(e,r,o):a(o))||o);return s&&o&&mt(e,r,o),o};let V=class extends f{constructor(){super(...arguments),this.locale=d.getCurrentLocale()}connectedCallback(){super.connectedCallback(),this._unsub=d.subscribe(()=>{this.locale=d.getCurrentLocale()})}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._unsub)==null||t.call(this)}t(t){return d.t(t)}render(){const t=d.t.bind(d);return h`
  ...
  `;Ie([k()],V.prototype,"locale",2);V=Ie([b("cta-section")],V);var ft=Object.getOwnPropertyDescriptor,ut=(t,e,r,s)=>{for(var o=s>1?void 0:s?ft(e,r):e,i=t.length-1,a;i>=0;i--)(a=t[i])&&(o=a(o)||o);return o};let te=class extends f{render(){return h`
      <footer class="footer">
        <div class="inner">
          <div class="brand">
  ...
  `;te=ut([b("pi-footer")],te);var bt=Object.getOwnPropertyDescriptor,vt=(t,e,r,s)=>{for(var o=s>1?void 0:s?bt(e,r):e,i=t.length-1,a;i>=0;i--)(a=t[i])&&(o=a(o)||o);return o};let re=class extends f{constructor(){super(...arguments),this.particles=[],this.PARTICLE_COUNT=30,this.CONNECTION_DISTANCE=150,this.MAX_CONNECTIONS=3,this.animate=()=>{!this.ctx||!this.canvas||(this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height),this.particles.forEach((t,e)=>{t.x+=t.vx,t.y+=t.vy,(t.x<0||t.x>this.canvas.width)&&(t.vx*=-1),(t.y<0||t.y>this.canvas.height)&&(t.vy*=-1),this.ctx.beginPath(),this.ctx.arc(t.x,t.y,t.radius,0,Math.PI*2),this.ctx.fillStyle=`rgba(16, 185, 129, ${t.opacity})`,this.ctx.fill();let r=0;for(let s=e+1;s<this.particles.length&&!(r>=this.MAX_CONNECTIONS);s++){const o=this.particles[s],i=t.x-o.x,a=t.y-o.y,c=Math.sqrt(i*i+a*a);if(c<this.CONNECTION_DISTANCE){const n=(1-c/this.CONNECTION_DISTANCE)*.15;this.ctx.beginPath(),this.ctx.moveTo(t.x,t.y),this.ctx.lineTo(o.x,o.y),this.ctx.strokeStyle=`rgba(16, 185, 129, ${n})`,this.ctx.lineWidth=.5,this.ctx.stroke(),r++}}}),this.animationId=requestAnimationFrame(this.animate))}}firstUpdated(){this.canvas=this.renderRoot.querySelector("canvas"),this.canvas&&(this.ctx=this.canvas.getContext("2d")||void 0,this.ctx&&(this.setupCanvas(),this.initParticles(),this.animate(),this.resizeObserver=new ResizeObserver(()=>{this.setupCanvas()}),this.resizeObserver.observe(this.canvas)))}setupCanvas(){var e;if(!this.canvas)return;const t=(e=this.canvas.parentElement)==null?void 0:e.getBoundingClientRect();t&&(this.canvas.width=t.width,this.canvas.height=t.height)}initParticles(){if(this.canvas){this.particles=[];for(let t=0;t<this.PARTICLE_COUNT;t++)this.particles.push({x:Math.random()*this.canvas.width,y:Math.random()*this.canvas.height,vx:(Math.random()-.5)*.3,vy:(Math.random()-.5)*.3,radius:Math.random()*1.5+.5,opacity:Math.random()*.3+.1})}}disconnectedCallback(){var t;super.disconnectedCallback(),this.animationId&&cancelAnimationFrame(this.animationId),(t=this.resizeObserver)==null||t.disconnect()}render(){return h`<canvas></canvas>`}};re.styles=x`
    :host {
      display: block;
      position: fixed;
      inset: 0;
  ...
  `;re=vt([b("canvas-background")],re);var yt=Object.getOwnPropertyDescriptor,wt=(t,e,r,s)=>{for(var o=s>1?void 0:s?yt(e,r):e,i=t.length-1,a;i>=0;i--)(a=t[i])&&(o=a(o)||o);return o};let we=class extends f{createRenderRoot(){return this}render(){return h`
