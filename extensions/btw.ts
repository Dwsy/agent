...
const BTW_SYSTEM_PROMPT = [
  ...
  "You are a standalone assistant - do not reference or assume knowledge of the main conversation.",
...
function buildSeedMessages(
  ...
  // Prefix cache optimization: only inject BTW conversation history
  // System prompt + tools are set via createBtwResourceLoader (stable prefix)
  // No main session messages injected to avoid prefix changes and cache misses
