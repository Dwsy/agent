/** Knowledge-base operation executor, dispatched by the `role_exec` / `role_search` tools. */
...
/**
 * Executes one knowledge operation (`params.action`: list/search/read/write).
 * `role_exec` dispatches kb_* ops here, `role_search` reuses the search branch.
 */
export async function executeKnowledgeOp(rt: Runtime, params: Record<string, any>) {
