/** Memory operation executor, dispatched by the `role_exec` / `role_search` tools. */
...
/**
 * Executes one memory operation (`params.action`). Not registered as a tool
 * itself: `role_exec` dispatches ops here, `role_search` reuses the search
 * branch. Returns tool-result shaped objects.
 */
export async function executeMemoryOp(rt: Runtime, params: Record<string, any>, ctx?: any) {
