...
- [ ] 创建完整的插件目录结构：`~/.pi/agent/extensions/checkpoint-v2/`
- [ ] 创建所有模块文件（空文件或基本结构）
- [ ] 定义完整的 TypeScript 类型（types.ts）
- [ ] 创建插件入口文件（index.ts）基本结构
- [ ] 定义 Git 存储目录路径常量（`~/.pt/git`）
...
- [ ] `~/.pi/agent/extensions/checkpoint-v2/index.ts`
- [ ] `~/.pi/agent/extensions/checkpoint-v2/types.ts`
- [ ] `~/.pi/agent/extensions/checkpoint-v2/utils.ts`
- [ ] `~/.pi/agent/extensions/checkpoint-v2/file-tracker.ts`
- [ ] `~/.pi/agent/extensions/checkpoint-v2/checkpoint-manager.ts`
- [ ] `~/.pi/agent/extensions/checkpoint-v2/git-storage.ts`
- [ ] `~/.pi/agent/extensions/checkpoint-v2/commands.ts`
- [ ] `~/.pi/agent/extensions/checkpoint-v2/components/file-changes-viewer.ts`
- [ ] `~/.pi/agent/extensions/checkpoint-v2/components/revert-info.ts`
- [ ] `~/.pi/agent/extensions/checkpoint-v2/components/diff-viewer.ts`
- [ ] `~/.pt/` 目录（Git 存储目录）