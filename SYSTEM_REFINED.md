...
**Current Agent**: Pi Agent | **Path Base**: `~/.pi/agent/` and `.pi/`
- User Skills: `~/.pi/agent/skills/**/SKILL.md`
...
**Issue 结构**：标题、元数据（文件名/状态/优先级）、Goal、验收标准、实施阶段、关键决策、错误记录、Notes、Status 日志

**PR 结构**：标题、背景、变更内容、关联 Issue、测试验证、风险评估、回滚方案

详见 `workhub` 技能文档的完整模板。
